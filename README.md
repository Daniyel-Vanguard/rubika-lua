...
1. به @RubikaBot در روبیکا مراجعه کنید
2. دستور /newbot را ارسال کنید
3. نام و یوزرنیم ربات را انتخاب کنید
4. توکن دریافتی را در فایل config قرار دهید
...
- ✅ مثال‌های کد مختلف
- ✅ راه‌اندازی Webhook با Ngrok
- ✅ عیب‌یابی مشکلات رایج
- ✅ ساختار پروژه
- ✅ راهنمای مشارکت
- ✅ بادج‌های حرفه‌ای

هر بخشی که نیاز به تغییر داره بهم بگو تا برات ویرایش کنم! 🚀